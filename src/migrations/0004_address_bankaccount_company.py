    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bank_account_number', models.CharField(max_length=32, verbose_name='Bank account number')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tax_id', models.CharField(max_length=100, verbose_name='Tax ID')),
                ('address', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='src.Address', verbose_name='Address')),
                ('bank_account', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='src.BankAccount', verbose_name='Bank account')),
            ],
            options={
